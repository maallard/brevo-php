...
class GetSmsCampaignsResponseCampaignsItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<GetSmsCampaignsResponseCampaignsItemStatus> $status Status of the SMS Campaign
     */
    #[JsonProperty('status')]
...
//    public GetCampaignRecipients $recipients;
     ...
     *   name: string,
     *   sender: string,
     *   status: value-of<GetSmsCampaignsResponseCampaignsItemStatus>,
